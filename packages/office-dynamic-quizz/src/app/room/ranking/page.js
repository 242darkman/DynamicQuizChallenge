      ...
      <div>
        ...
        <div className="flex items-center justify-center gap-20 mb-10 mt-5">
          <div>
            ...
            <p className="text-white font-bold p-2 text-xl">John</p>
          </div>
          ...
          <div className="mb-20">
            ...
            <p className="text-white font-bold p-2 text-xl">Silver</p>
          </div>
          ...
          <div>
            ...
            <p className="text-white font-bold p-2 text-xl">Magic</p>
          </div>
        </div>
